...
struct ei_frame_t* frame_drawfunc(struct ei_widget_t*	frame,
	...
	int x=widget.screen_location.top_left.x; /*Origine du dessin*/
	...
	hw_surface_update_rects(suface, NULL);
	hw_surface_update_rects(pick_suface, NULL);
